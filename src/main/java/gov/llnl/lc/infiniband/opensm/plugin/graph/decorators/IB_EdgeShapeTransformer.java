 ...
 *
 *        file: IB_EdgeShapeTransformer.java
 *
...
public class IB_EdgeShapeTransformer extends EdgeShape.Line<IB_Vertex, IB_Edge>
{
  VisualizationViewer<IB_Vertex,IB_Edge> visViewer = null;

  public IB_EdgeShapeTransformer()
  {

  }
  
  public Shape transform(Context<Graph<IB_Vertex,IB_Edge>,IB_Edge> context)
  {
