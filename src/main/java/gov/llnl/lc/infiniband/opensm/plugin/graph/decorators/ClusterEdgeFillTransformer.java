 ...
 *
 *        file: ClusterEdgeFillTransformer.java
 *
...
public class ClusterEdgeFillTransformer extends PickableEdgePaintTransformer<IB_Edge>
{
  PickedInfo<IB_Edge> PI;
  Paint Draw_paint;
  Paint Picked_paint;


    public ClusterEdgeFillTransformer(PickedInfo<IB_Edge> pi, Paint draw_paint, Paint picked_paint)
  {
    super(pi, draw_paint, picked_paint);
    // TODO Auto-generated constructor stub
    PI = pi;
    Draw_paint = draw_paint;
    Picked_paint = picked_paint;
