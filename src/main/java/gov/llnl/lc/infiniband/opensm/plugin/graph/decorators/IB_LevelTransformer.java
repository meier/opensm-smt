...
public class IB_LevelTransformer implements Transformer<Object, Paint>
{
  ...
  public int getEdgeDecoratorNumber(Object e)
  {
    if (e instanceof IB_Edge)
    {
      IB_Edge te = (IB_Edge) e;
//      Collection picked = new HashSet(visViewer.getPickedEdgeState().getPicked());
//      for (Object pv : picked)
//      {
//        if (pv instanceof IB_Edge)
//        {
//          if (pv.equals(te))
//            return getPickedNumber();
//        }
//      }
  ...
  public int getDecoratorNumber(Object o)
  {
    ...
    if (o instanceof IB_Edge)
    {
      return getEdgeDecoratorNumber(o);
    }
    if (o instanceof UndirectedSparseMultigraph)
    {
