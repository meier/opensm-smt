...
public class FabricTreeModelOld implements TreeModel
{  
  ...
  public FabricTreeModelOld(UserObjectTreeNode RootVertexNode)
  {
    super();
  ...
  public FabricTreeModelOld(IB_Vertex root)
  {
    this(new UserObjectTreeNode(new NameValueNode((root == null ? "": root.getName()), root ), true));
 }

  public FabricTreeModelOld(HashMap <String, IB_Vertex> VertexMap, OSM_Fabric fabric)
  {
