...
public class GraphLayoutChooser implements ActionListener
{
  private final JComboBox           jcb;
  private final VisualizationViewer vv;
  private final SimpleCollapsableGraph cgv;

  public GraphLayoutChooser(JComboBox jcb, VisualizationViewer vv, SimpleCollapsableGraph cgv)
  {
    super();
    this.jcb = jcb;
    this.vv = vv;
