...
public class VertexTreeNode extends DefaultMutableTreeNode
{
  ...
  public VertexTreeNode(Object userObject, boolean allowsChildren)
  {
  ...
  public String toString()
  {
    ...
    int maxSize = 30;
    int endex = v.toString().length();
    endex = endex > maxSize ? maxSize: endex;
    
    return v.toString().substring(0, endex);
  }
