 ...
 *
 *        file: IB_EdgeDrawTransformer.java
 *
...
public class IB_EdgeDrawTransformer implements Transformer<IB_Edge, Paint>
{
  VisualizationViewer<IB_Vertex,IB_Edge> visViewer = null;

  public IB_EdgeDrawTransformer()
  {
  ...
  {
    // red if picked, otherwise black
    if(visViewer.getPickedEdgeState().isPicked(e))
      return Color.RED;
    return Color.BLACK;
  }
