...
public interface OMS_Updater
{
   ...
   **/
   /**
   *** Adds an object to the list that wants to receive notification when a 
   *** new OMS is available.
   *** <p>
   ***
   *** @param  listener        object to be added to the listener list
   **************************************************************************/
   public void addListener(OSM_ServiceChangeListener listener);
   /*-----------------------------------------------------------------------*/
   ...
   **/
   /**
   *** Removes an object from the list that wants to receive notification when a
   *** new OMS is available.
   *** <p>
   ***
   *** @param  listener        object to be removed from the listener list
   **************************************************************************/
   public boolean removeListener(OSM_ServiceChangeListener listener);
   /*-----------------------------------------------------------------------*/
