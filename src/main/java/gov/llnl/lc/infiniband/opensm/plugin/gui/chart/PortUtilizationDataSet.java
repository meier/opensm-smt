...
public class PortUtilizationDataSet implements HeatMapDataset, CommonLogger
{
 ...
 */
  ...
  **/
   ...
   *
   ***********************************************************/
  public PortUtilizationDataSet(String fileName)
  {
   ...
   logger.severe("Done reading the file: " + fileName);
    ...
    createMapDataSet(history);
  }

  public PortUtilizationDataSet(OMS_Collection history)
  {
    createMapDataSet(history);
  }

  private void createMapDataSet(OMS_Collection history)
  {
     omsHistory     = history;
...
//      System.err.println("The size of the guid list is: " + IncludedGuids.size());
  ...
  public static void main(String[] args)
  {
    ...
    new PortUtilizationDataSet(SmtCommand.convertSpecialFileName("%h/scripts/OsmScripts/SmtScripts/sierra3H.his"));
